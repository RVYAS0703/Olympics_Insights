...
# st.sidebar.image('https://www.pngegg.com/en/png-zjvpn')
...
if user_menu == 'Country-wise Analysis':
    ...
    x=helper.yearwise_meda_tally(df,selected_country)
    ...
    st.title("Top 10 Atheletes " + selected_country)
    top10 = helper.most_successful_athelete(df,selected_country)
    st.table(top10)
